...
readonly compose_prefix="$docker_prefix compose --project-name finance-reconciliation --env-file /volume4/docker/docker/finance-reconciliation/app/.env -f /volume4/docker/docker/finance-reconciliation/app/compose.yml"
readonly raw_sentinel="Traceback Token=private-token Cookie=private-cookie password=private-password sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa finance-reconciliation-rollback-web:11111111-1111-1111-1111-111111111111 /private/app"
suite_dir="$(mktemp -d)"
...
compose_prefix="--host unix:///var/run/docker.sock compose --project-name finance-reconciliation --env-file /volume4/docker/docker/finance-reconciliation/app/.env -f /volume4/docker/docker/finance-reconciliation/app/compose.yml"
case "$*" in
...
SH
  ...
  environment=(
    ...
    "FINREC_CONFIRM_MANUAL_CLEANUP=${FINREC_CONFIRM_MANUAL_CLEANUP-yes}"
    "FINREC_APP_DIR=/browser/controlled/app"
    "FINREC_COMPOSE_PROJECT=browser-controlled-project"
...
assert_no_sentinel_leak() {
  ...
  for forbidden in \
    ...
    finance-reconciliation-rollback-web:11111111-1111-1111-1111-111111111111 \
    /private/app \
