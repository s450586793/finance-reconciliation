...
```text
/volume4/docker/docker/finance-reconciliation/deploy-backups/supplier-reconciliation-20260731/
```
...
Run on DSM from `/volume4/docker/docker/finance-reconciliation/app`:
